...
Xray executables are downloaded from official XTLS/Xray-core releases when a launch or build script needs them. Downloaded files in this directory are intentionally ignored by Git.
